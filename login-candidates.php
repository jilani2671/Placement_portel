...
<body class="hold-transition login-page bg-blue-100 text-white">
  ...
  <div class="login-box hello">
    ...
    <!-- /.login-logo -->
    <div class="rounded-xl shadow-2xl d-flex flex-column justify-content-center align-items-center login-box-body bg-blue-200 text-black ">
      ...
      "
      >
      <p class="login-box-msg text-2xl fw-bolder text-black">Student Login</p>
      ...
      <form method="post" action="checklogin.php " class="text-xl">
        ...
        <div class="row">
          <div class="col-xs-8">
            ...
            <a class="text-xl text-black fw-bold" href="register-candidates.php">Create new account</a>
          </div> 
          <!-- /.col -->
          <div class="col-xs-4">
