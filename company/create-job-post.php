  ...
  <div class="wrapper">
              ...
              <div class="row">
                <form method="post" action="addpost.php">
                  <div class="col-md-12 latest-job ">
                    ...
                    <div class="form-group">
                      <input type="number" class="form-control  input-lg" id="maximumsalary" name="maximumsalary" placeholder="Eligibility Criteria (percentage)" required="">
                    </div>
                    <div class="form-group">
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2024 <a href="tkiet">Placement Portal</a>.</strong> All rights
        reserved.
      </div>
    </footer>
