...
<body class="hold-transition login-page bg-gray-800 text-white">
  ...
  <div class="login-box " id="sms">
    ...
    <div class="rounded-xl shadow-2xl d-flex flex-column justify-content-center align-items-center bg-gray-900 text-white login-box-body large">
    
      <p class="login-box-msg mt-7 text-2xl">Admin Login</p>
      <style>
        .large {
          width: 350px;
          height: 260px;
