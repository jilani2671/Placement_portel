...
<body class="hold-transition login-page bg-blue-100 text-white">
  ...
  <div class="login-box content:centre">
    ...
    <!-- /.login-logo -->
    <div class="rounded-xl shadow-2xl d-flex flex-column justify-content-center align-items-center login-box-body bg-blue-200 text-black text-xl">
    <img src="assets\img\dypLogo\DYP-ATU logo.png" alt="" class="mb-3" 
...
"
>
      <p class="text-white text-2xl fw-bolder login-box-msg text-black">Company Login</p>
      ...
      <form method="post" action="checkcompanylogin.php">
        ...
        <div class="row">
          <div class="col-xs-8">
            ...
            <a class="fw-bold text-xl text-black" href=" register-company.php">Create new account</a>
          </div>
          <!-- /.col -->
          <div class="col-xs-4">
