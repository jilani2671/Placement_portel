  ...
  <div class="wrapper">
      ...
      <section class="content-header">
        <div class="container ">
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            <h3 class="text-center margin-bottom-20">Student Registration</h3>
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              ...
              <div class="col-md-6 latest-job ">
                ...
                <div class="d-flex justify-content-between form-group checkbox">
                  <label><input type="checkbox"> I accept terms & conditions</label>
                <!-- </div>
                <div class="form-group"> -->
                  <button class="btn btn-flat btn-success" style="margin-left:10px;">Register</button>
                </div>
              </div>
            </form>
    ...
    <footer class="main-footer" style="margin-left: 0px;">
      <div class="text-center">
        <strong>Copyright &copy; 2024 DYP Placement Portal.</strong> All rights
        reserved.
      </div>
    </footer>
